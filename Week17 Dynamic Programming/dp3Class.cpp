...
void printArray(vector<vector<int>> &dp){
...
// int solveUsingSpaceOptimazition(int n, int k ){
//     // vector<int>dp(n+1, -1);
//     int prev2 = k;
//     int prev1 =  k + k*(k-1);
//     if(n==1){
...
//     int ans = solveUsingSpaceOptimazition(n, k);
