...
#include<queue>
 ...
 void  mergeKSortedArrays( int arr[][4], int n, int k, vector<int> &ans){
    ...
    while(!pq.empty()){
        ...
        // next element for the  same row , jusme se pop kia h just abhi use insert bhi to karna hai

        if(topCol + 1<n){
            // iska mtlab row me or element ahi present hai 
